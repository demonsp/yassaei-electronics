...
var RAW, S1, S2, stripMarks, raw, ESC_MAP, qs, GLYPH_ICON, catIcon, LOCALE;
var init_dom = __esm({
  "public/js/lib/dom.mjs"() {
...
var TYPE_CLASS = { success: "success", error: "error", warn: "warning", warning: "warning", info: "info" };
var TYPE_ICON = { success: "check-circle", error: "alert", warn: "alert", warning: "alert", info: "info" };
var toastSeq = 0;
function toast(message, { type = "info", title: title2 = "", timeout = 3800, action = null } = {}) {
  ...
  node.innerHTML = html`
    ...
    <div class="grow">
      ${title2 ? html`<div class="toast-t">${title2}</div>` : ""}
      <div class="${title2 ? "toast-d" : "toast-t"}">${message}</div>
    </div>
...
var toastError = (m, o) => toast(m, { type: "error", timeout: 5600, ...o });
...
function emptyState({ icon: ic = "box", title: title2 = "", text = "", action = null, act = null } = {}) {
  return html`
    <div class="empty">
      <span class="empty-ic">${icon(ic)}</span>
      <h4>${title2 || t("common.noData")}</h4>
      ${text ? html`<p>${text}</p>` : ""}
