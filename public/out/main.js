...
`).map(f=>f.trim()).filter(Boolean))}return l})}return s}function Gd(e){return M(e),null}var j,Ma,Jr,Wd,$s,ws,ec=z(()=>{F();_();J();ie();X();de();ae();j=(e,a)=>k()?e:a,Ma=[{key:"about",icon:"store",blocks:["hero","sections","stats"]},{key:"guide",icon:"info",blocks:["hero","steps","tips"]},{key:"service",icon:"headset",blocks:["hero","items"]},{key:"faq",icon:"help",blocks:["faq"]},{key:"terms",icon:"file",blocks:["hero","intro","notice","sections"]},{key:"privacy",icon:"shield",blocks:["hero","intro","sections"]},{key:"insurance",icon:"package-check",blocks:["hero","body","rules"]},{key:"ticketRules",icon:"ticket",blocks:["hero","rules"]},{key:"bugReport",icon:"bug",blocks:["hero","body","hints"]},{key:"contact",icon:"phone",blocks:["hero"]},{key:"installments",icon:"card",blocks:["hero","body","rules","sections"]}],Jr={};Wd=()=>({title:"",titleEn:"",body:"",bodyEn:"",list:[],listEn:[]});$s=()=>r`
  ...
  </div>`)});km().catch(e=>{console.error("[boot]",e),document.getElementById("welcomeScreen")?.remove();let a=I("#bootSplash");a&&(a.innerHTML=r`<div class="empty"><h4>${t("err.generic")}</h4><button class="btn btn-primary" data-act="reload">${t("common.retry")}</button></div>`)});setTimeout(Wm,6e3);Vm=240*1e3,mc=0});Xn();export{Ym as ecoPaused,bc as maybeConsent,ua as updateBadges};
