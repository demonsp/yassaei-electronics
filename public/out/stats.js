...
var RAW, S1, S2, stripMarks, raw, ESC_MAP, FA_DIGITS, LOCALE;
var init_dom = __esm({
  "public/js/lib/dom.mjs"() {
...
// public/js/components.mjs
function sectionHead({ titleIcon = "", title = "", sub = "", link = null, linkLabel = "" }) {
  return html`
...
async function render() {
  let data = null;
  try {
    data = await api.get("/api/stats/public");
  } catch {
  }
  if (!data) return html`<div class="empty"><h4>${t("err.network")}</h4></div>`;
