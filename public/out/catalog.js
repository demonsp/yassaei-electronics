...
var init_admin = __esm({
  "public/js/views/admin/index.mjs"() {
    ...
    SECTIONS2 = [
      ...
      { grp: "shop", id: "categories", perm: "categories.manage", icon: "layers", label: () => t("adm.categories"), mod: () => Promise.resolve().then(() => (init_catalog(), catalog_exports)) },
...
var init_router = __esm({
  "public/js/router.mjs"() {
    ...
    routes = [
      ...
      { pattern: "/products", load: () => Promise.resolve().then(() => (init_catalog2(), catalog_exports2)), title: () => t("catalog.title") },
      { pattern: "/category/:id", load: () => Promise.resolve().then(() => (init_catalog2(), catalog_exports2)), title: () => t("catalog.title") },
