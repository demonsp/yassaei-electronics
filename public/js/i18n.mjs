...
const fa = {
  ...
  'home.heroKicker': 'از تهران، با ضمانت اصالت',
  'home.heroTitle': 'لوازم الکترونیک و الکتریکی، با قیمت تهرانی',
...
const en = {
  ...
  'home.heroKicker': 'From Tehran, with an authenticity guarantee',
  'home.heroTitle': 'Electronics & electrical supplies at port prices',
